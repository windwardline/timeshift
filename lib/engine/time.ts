 ...
 * tables (see AGENTS.md §4). A JS `Date` is an absolute instant; re-expressing
 ...
 * it rather than hand-rolling DST logic (see AGENTS.md §4).
 *
 ...
 * that day exactly once with no calendar arithmetic (see AGENTS.md §4). The
 ...
 * 2024-02-29 forward to 2025-03-01, so we delegate to Luxon (AGENTS.md §4).
 */
